...
const config: SiteConfig = {
  ...
  giscus: {
    repo: 'hamza-m-masood/blog',
    repoId: 'R_kgDOKjbcRw',
    category: 'Announcements',
    categoryId: 'DIC_kwDOKjbcR84DEgzK',
  ...
  characters: {
    ...
    readingDuck: '/readingDuck.webp',
    pointingDuck: '/pointingDuck.webp',
    wavingDuck: '/wavingDuck.webp',
    thumbsUpDuck: '/thumbsUpDuck.webp',
    thumbsDownDuck: '/thumbsDownDuck.webp',
    facepalmDuck: '/facepalmDuck.webp',
    shockedDuck: '/shockedDuck.webp',
    suspiciousDuck: '/suspiciousDuck.webp',
    sleepingDuck: '/sleepingDuck.webp',
    sickDuck: '/sickDuck.webp',
    wizardDuck: '/wizardDuck.webp',
    cryingDuck: '/cryingDuck.webp',
    armsCrossedDuck: '/armsCrossedDuck.webp',
    letterDuck: '/letterDuck.webp',
    proudDuck: '/proudDuck.webp',
    staringDuck: '/staringDuck.webp',
    eyesDuck: '/eyesDuck.webp',
    nurseDuck: '/nurseDuck.webp',
    bothThumbsUpDuck: '/bothThumbsUpDuck.webp',
    coverEyesDuck: '/coverEyesDuck.webp',
    gaspDuck: '/gaspDuck.webp',
    giggleDuck: '/giggleDuck.webp',
    angryDuck: '/angryDuck.webp',
    surprisedDuck: '/surprisedDuck.webp',
    tearDuck: '/tearDuck.webp',
    armsUpDuck: '/armsUpDuck.webp',
